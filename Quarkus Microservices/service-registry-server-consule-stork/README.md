# service-registry-server-consule-stork
...
You can then execute your native executable with: `./target/service-registry-server-consule-stork-1.0.0-SNAPSHOT-runner`
